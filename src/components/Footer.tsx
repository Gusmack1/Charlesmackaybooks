  ...
  return (
    <footer className="bg-[#2a384a] text-white py-8 sm:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 mb-8">
          ...
          <div className="text-center">
            ...
            <div className="space-y-2 text-sm">
              <Link href="/research-guides" className="block text-blue-300 hover:text-blue-200">
                Aviation Research Guides
              </Link>
              <Link href="/aviation-glossary" className="block text-blue-300 hover:text-blue-200">
                Aviation Glossary
              </Link>
              <Link href="/scottish-aviation-timeline" className="block text-blue-300 hover:text-blue-200">
                Scottish Aviation Timeline
              </Link>
              <Link href="/faq" className="block text-blue-300 hover:text-blue-200">
                Frequently Asked Questions
              </Link>
              <Link href="/for-researchers" className="block text-blue-300 hover:text-blue-200">
                Academic Resources
              </Link>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-blue-300 text-sm font-mono bg-gray-700 p-3 rounded">
            ...
            <div className="space-y-2 text-sm">
              <div>
                ...
                <a
                  ...
                  className="text-blue-300 hover:text-blue-200 ml-1 break-all"
                >
                  charlese1mackay@hotmail.com
                </a>
              </div>
              <div><strong>eBay Store:</strong> <span className="text-blue-300">chaza87</span></div>
        ...
        <div className="text-center text-sm text-gray-400 mt-8 pt-8 border-t border-gray-600">
