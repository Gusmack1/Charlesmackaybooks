    ...
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-12 bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 border border-slate-200 dark:border-slate-700">
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <a href="/books" className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 hover:from-slate-800 hover:via-blue-800 hover:to-slate-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors">Browse all books</a>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-slate-900/95 backdrop-blur border-t border-slate-700">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <a href="/books" className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 hover:from-slate-800 hover:via-blue-800 hover:to-slate-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors">Buy Books</a>
        </div>
      </div>
