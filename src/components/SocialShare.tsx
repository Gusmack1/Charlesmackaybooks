...
export default function SocialShare({ url, title, description, hashtags = [], author = 'Charles E. MacKay' }: SocialShareProps) {
  ...
  const shareLinks = {
    twitter: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedTitle}&hashtags=${hashtagString}&via=charlesmackay`,
    ...
    <div className="card p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        ...
        <button
          ...
          className="flex items-center justify-center p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          className="flex items-center justify-center p-3 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          className="flex items-center justify-center p-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors duration-200"
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
        ...
        <button
          ...
          className="flex items-center justify-center p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          className="flex items-center justify-center p-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors duration-200"
        ...
        <button
          ...
          className="flex items-center justify-center p-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors duration-200"
