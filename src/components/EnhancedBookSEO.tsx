...
export default function EnhancedBookSEO({ book, relatedBlogPosts = [] }: EnhancedBookSEOProps) {
  ...
  // Generate Review schema (aggregate reviews from eBay feedback)
  const generateReviewSchema = () => {
    // Based on eBay feedback showing 100% positive feedback (1743 reviews)
    return {
      '@type': 'AggregateRating',
      '@id': `${baseUrl}/books/${book.id}#aggregateRating`,
      ratingValue: '5.0',
      reviewCount: '1743',
      bestRating: '5',
      worstRating: '1',
      ratingExplanation: 'Based on customer reviews from charlesmackaybooks.com and eBay seller chaza87 with 100% positive feedback.'
    };
  };
  ...
  const organizationSchema = {
    ...
    name: 'Charles E. MacKay Publishing',
    url: baseUrl,
    logo: `${baseUrl}/charles-mackay-aviation-historian.jpg`,
    description: 'Publisher of authoritative aviation history books by renowned historian Charles E. MacKay',
    address: {
      '@type': 'PostalAddress',
      addressLocality: 'Glasgow',
      addressCountry: 'Scotland',
  ...
  const authorSchema = {
    ...
    '@id': `${baseUrl}/about#author`,
    name: 'Charles E. MacKay',
    alternateName: ['Charles MacKay', 'Charles E MacKay', 'C.E. MacKay'],
    jobTitle: 'Aviation Historian and Author',
    description: 'Renowned aviation historian specializing in Scottish and British aviation heritage, WWI/WWII aircraft, helicopter development, jet age innovations, and military aviation. With over 19 published books and more than 1,700 satisfied customers worldwide.',
    url: `${baseUrl}/about`,
    email: 'charlese1mackay@hotmail.com',
    ...
    award: [
      '100% Positive eBay Feedback (1743 reviews)',
      'Trusted Aviation History Author'
    ],
    memberOf: [
      {
        '@type': 'Organization',
        name: 'Aviation History Research Community'
      }
    ]
  };
  ...
  return (
    <>
      {/* Author Schema - Enhanced for E-E-A-T */}
      <script
