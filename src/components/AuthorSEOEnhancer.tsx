      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a href="/books" className="bg-white text-slate-900 px-6 py-3 rounded-lg hover:bg-gray-100 hover:underline transition-colors border border-slate-900">
              Browse All Books
            </a>
            <a href="/contact" className="bg-white text-slate-900 px-6 py-3 rounded-lg hover:bg-gray-100 hover:underline transition-colors border border-slate-900">
              Contact Author
            </a>
          </div>
        </div>
