  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Order Summary */}
        <div className="bg-blue-800/60 p-4 rounded-lg">
        ...
        {/* Payment Element */}
        <div className="border border-blue-700/50 rounded-lg p-4 bg-blue-800/60">
          <PaymentElement 
            options={{
              layout: 'tabs',
              defaultValues: {
        ...
        {/* Security Notice */}
        <div className="bg-blue-900/50 border border-blue-700/50 rounded-lg p-4">
          <div className="flex">
            <div className="flex-shrink-0">
