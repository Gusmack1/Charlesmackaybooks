      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <SocialShare
            url={pageUrl}
            title={pageTitle}
            description="Discover how the F-86 Sabre dominated MiG Alley during the Korean War and established Western air superiority. Learn about this revolutionary swept-wing fighter that defined Cold War aviation."
            hashtags={['F86Sabre', 'ColdWar', 'KoreanWar', 'JetFighter', 'MiGAlley', 'ColdWarAviation', 'AviationHistory', 'CharlesMacKay']}
          />
        </div>
      </div>
