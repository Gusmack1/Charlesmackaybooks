...
const post = {
  ...
  content: `
    ...
    <p>
      The book describes the evolution and deployment of the Canadair Sabre in Royal Air Force, Royal Canadian Air Force and in NATO service-includes the West German Air Force. This comprehensive coverage demonstrates how the Sabre became a cornerstone of NATO air defence. this historical context shows how the Sabre became operational.
    </p>
    <p>
      The Mutual Defence Aid Programme (MDAP) facilitated Sabre deployment across NATO, demonstrating how international cooperation supported air defence requirements. The documentation of MDAP deployment ensures that Sabre's international role is documented.
    </p>
    ...
    <p>
      North American Aviation's wartime experience with the P-51 Mustang demonstrated the company's ability to produce reliable, effective fighters. This experience informed Sabre development, ensuring that production considerations were integrated into design. The documentation of industrial context ensures that Sabre's development is documented.
    </p>
    <p>
      Early straight-wing studies gave way to swept-wing research informed by captured German data and domestic testing. This transition demonstrated how wartime technology transfer influenced post-war development. The documentation of design evolution ensures that aerodynamic development is documented.
    </p>
    <p>
      The company's design culture prioritized clear manufacturing drawings, maintainable systems, and flight-test feedback loops. This approach enabled rapid block improvements in service, demonstrating how design philosophy supported operational effectiveness. The documentation of design culture ensures that Sabre's development methodology is properly preserved.
    </p>
    ...
    <p>
      Automatic leading-edge slats improved low-speed lift and stall behaviour, enabling aggressive manoeuvring without sudden departure. This combination of swept wings and slats created an aircraft that performed well across a wide speed range. The documentation of slat development ensures that handling characteristics are properly understood.
    </p>
    <p>
      The tailplane and fin were tuned to provide stable pitch authority through compressibility. As aircraft approached Mach 1, conventional elevators lost effectiveness due to shock wave formation. The Sabre's tail design provided pitch control authority throughout the transonic regime. The documentation of flight control development shows how these achievements are properly understood.
    </p>
    ...
    <p>
      The book describes engine development including the J-47, Orenda and the Rolls-Royce Nene manufactured in Canada. This comprehensive coverage demonstrates how different engine types powered Sabre variants. engine development shows how Sabre capabilities evolved.
    </p>
    <p>
      USAF variants used the J47‑GE‑13/27/33 family with improvements in compressor and turbine metallurgy. These improvements extended engine life and improved reliability, essential for operational deployments. The documentation of engine improvements ensures that Sabre reliability is documented.
    </p>
    <p>
      Canadair Sabre variants used Orenda engines, providing Canadian-built powerplants for NATO deployments. The Rolls-Royce Avon powered Australian Avon Sabre variants, delivering higher thrust and improved performance. The documentation of engine variants ensures that Sabre diversity is properly recognized.
    </p>
    <p>
      Fuel and electrics systems were reliable for winter operations, with de-icing and bleed-air management for canopy and pitot. These systems demonstrated how operational requirements influenced design. The documentation of systems design ensures that operational considerations are properly understood.
    </p>
    ...
    <p>
      The A-1C(M) gunsight with radar ranging (APG-30) represented a significant advance in fire control technology. Radar ranging provided accurate target distance information, enabling lead-computing solutions that improved gunnery accuracy. The documentation of fire control development ensures that Sabre's combat effectiveness is documented.
    </p>
    <p>
      Harmonisation practices and convergence settings were refined in theatre, demonstrating how operational experience influenced tactics. Gun-camera film closed the loop between training and combat gunnery, enabling rapid tactical evolution. The documentation of tactical evolution ensures that Sabre's combat effectiveness is properly preserved.
    </p>
    ...
    <p>
      The MiG-15's 35-degree swept wing and Klimov VK-1 engine (derived from the Rolls-Royce Nene) provided exceptional climb and high-altitude performance. However, the Sabre's superior roll rate, turn performance at medium speeds, and sighting solutions provided tactical advantages. The documentation of performance comparisons ensures that combat effectiveness is documented.
    </p>
    <p>
      Disciplined energy management evened the contest, demonstrating how pilot skill and tactics could overcome performance differences. Tactical pair work, vertical manoeuvre, and gunnery training were decisive factors in Sabre success. The documentation of tactical factors ensures that combat effectiveness is properly preserved.
    </p>
    <p>
    ...
    <p>
      USAF Sabre wings deployed to counter MiG activity in "MiG Alley," protecting B-29 operations and establishing local air superiority. This deployment demonstrated how Sabre operations supported broader campaign objectives. The documentation of Korean War operations ensures that Sabre effectiveness is properly recognized.
    </p>
    <p>
      Standard patrols involved section and flight tactics with altitude advantage and ground-controlled intercept support. These tactics demonstrated how operational systems supported Sabre effectiveness. The documentation of tactical procedures ensures that operational methods are properly preserved.
    </p>
    <p>
    ...
    <p>
      The Sabre community institutionalised lessons rapidly, distributing tactics notes across squadrons. This rapid learning demonstrated how operational experience could be quickly shared and applied. The documentation of tactical evolution ensures that Sabre's combat effectiveness is properly preserved.
    </p>
    ...
    <p>
      The air sea work of the SB-17G, Handley Page Hastings and the Grumman Albatross-the "Duck Buts" are included with illustrations and their control from Prestwick. This was for "Leapfrog" and "Bechers Brook." The documentation of these operations ensures that Sabre delivery methods are properly understood.
    </p>
    <p>
      RCAF Sabre operations across Europe demonstrated how Canadian-built aircraft contributed to NATO air defence. The documentation of RCAF operations ensures that Sabre's Canadian role is properly preserved.
    </p>

    <h2 id="scottish-aviation">Scottish Aviation and Sabre Refurbishment</h2>
    <p>
      The work of Scottish Aviation at Prestwick Airport and Renfrew Airport is also fully described and illustrated with regard to USAF and RCAF refurbishment contracts for the North American F-86E and the Canadair Sabre with the Avro CF-100. The documentation of Scottish Aviation work ensures that Sabre refurbishment operations are properly understood.
    </p>
    <p>
      Scottish Aviation's work demonstrated how British industry supported NATO operations through aircraft refurbishment. The documentation of refurbishment operations ensures that Sabre maintenance is properly preserved.
    </p>
    <p>
      The involvement of Scottish Aviation, Airwork, Westland etc. is explained as well as the Sabre's fate at Church Crookham. The documentation of these operations ensures that Sabre's complete story is properly preserved.
    </p>

    <h2 id="variants">Variants and Block Improvements</h2>
    <p>
      <strong>F‑86A/E:</strong> Early combat variants; "all‑flying" tail on E improved transonic pitch control. The F-86A represented the first production Sabre, while the F-86E introduced the all-flying tail that improved transonic pitch control. The documentation of variant development ensures that Sabre evolution is documented.
    </p>
    <p>
      <strong>F‑86F:</strong> Strengthened wing; later "6‑3" hard‑edge leading‑edge extension traded low‑speed slat benefits for high‑speed performance (slatted F‑86F‑40 restored benign low‑speed traits). The F-86F represented the definitive Korean War Sabre, with improvements that enhanced combat effectiveness. The documentation of F-86F development ensures that combat improvements are properly recognized.
    </p>
    <p>
      <strong>Canadair Sabre (CL‑13):</strong> Orenda‑powered production for Canada and allies; RAF Sabre Mk.4 equipped numerous Fighter Command squadrons in the early 1950s. The Canadair Sabre demonstrated how licensed production supported NATO operations. The documentation of Canadair production ensures that international production is properly recognized.
    </p>
    <p>
      <strong>Avon Sabre:</strong> Australian CAC CA‑27 with Rolls‑Royce Avon and 30 mm cannon — substantial performance and armament uplift. The Avon Sabre demonstrated how engine upgrades could enhance Sabre capabilities. The documentation of Avon Sabre development ensures that engine improvements are properly recognized.
    </p>
    ...
    <p>
      The book includes details of the Burns-Templar agreement which paved the way for intelligence co-operation authorised at the highest political level between the United States and the United Kingdom. This comprehensive coverage demonstrates how Sabre operations supported broader intelligence cooperation. The documentation of intelligence cooperation ensures that Sabre's role in Cold War operations is documented.
    </p>
    <p>
      The West German Air Force operated Sabres as part of NATO air defence, demonstrating how Sabre operations supported German rearmament. The documentation of German Sabre operations ensures that NATO integration is properly preserved.
    </p>
    ...
    <p>
      Modular access to guns, engine bays, and systems enabled rapid maintenance and turnaround. This design philosophy demonstrated how maintainability supported operational effectiveness. The documentation of maintenance procedures ensures that operational support is documented.
    </p>
    <p>
      Winterisation kits and hydraulic servicing practices were codified to protect reliability in freezing conditions. These operational procedures demonstrated how environmental considerations influenced maintenance practices. The documentation of winter operations ensures that operational challenges are properly preserved.
    </p>
    ...
    <p>
      Conversion training emphasized transonic handling, buffet recognition, and slat behaviour. These training elements demonstrated how jet aircraft required different skills than piston-engine aircraft. The documentation of conversion training ensures that pilot experiences are properly understood.
    </p>
    <p>
      Gunnery syllabi integrated radar-assisted sighting and film analysis, enabling rapid tactical evolution. This training approach demonstrated how operational experience could be quickly incorporated into training. The documentation of gunnery training ensures that combat effectiveness is properly preserved.
    </p>

    <h2 id="comparison-allied">Comparison with Allied Fighters</h2>
    <p>
      The Sabre compared favorably with other early Cold War fighters, demonstrating superior handling characteristics and reliability. Compared to the Gloster Meteor, the Sabre's swept-wing design provided better transonic performance. Compared to the Hawker Hunter, the Sabre's earlier service entry provided valuable operational experience. The documentation of comparisons ensures that Sabre's relative advantages are properly understood.
    </p>
    <p>
      The book includes details of the Gloster Meteor and the Bell P-59 in RAF service, providing context for Sabre comparisons. The documentation of these comparisons ensures that Sabre's position within early jet fighter development is documented.
    </p>
