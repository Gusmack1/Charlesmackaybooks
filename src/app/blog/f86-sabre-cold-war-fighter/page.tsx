...
export const metadata: Metadata = {
  title: 'F86 Sabre Cold War Fighter | Charles E. MacKay',
  description: 'Expert analysis and historical insights into F86 Sabre Cold War Fighter',
  keywords: ['F86 Sabre Cold War Fighter', 'Aviation History', 'Charles MacKay'],
  openGraph: {
    title: 'F86 Sabre Cold War Fighter',
    description: 'Expert analysis and historical insights into F86 Sabre Cold War Fighter',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'F86 Sabre Cold War Fighter'
      }
    ],
    locale: 'en_GB',
    type: 'article',
...
const post = {
  ...
  title: 'F86 Sabre Cold War Fighter',
  subtitle: 'Expert analysis and historical insights into F86 Sabre Cold War Fighter',
  content: `
    <div class="bg-amber-50 border-l-4 border-amber-400 p-6 mb-8">
      <p class="text-xl leading-relaxed text-gray-800 m-0">
        <strong>Aviation Excellence:</strong> Expert analysis and historical insights into F86 Sabre Cold War Fighter
      </p>
    </div>
  ...
  `,
  excerpt: 'Expert analysis and historical insights into F86 Sabre Cold War Fighter',
  author: {
  ...
  featuredImage: {
    url: '/blog-images/f86-sabre-cold-war-fighter.jpg',
    alt: 'F86 Sabre Cold War Fighter',
    caption: 'F86 Sabre Cold War Fighter'
  },
  category: 'Aviation History',
  tags: ['F86 Sabre Cold War Fighter', 'Aviation History', 'Charles MacKay'],
  relatedBooks: [],
  relatedPosts: []
};
