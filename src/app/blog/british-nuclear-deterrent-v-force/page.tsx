...
const blogData = {
  ...
  tags: ["british","nuclear","deterrent","v","force"],
  ...
  featuredImage: {"url":"/blog-images/british-nuclear-deterrent-v-force-featured.jpg","alt":"Featured image for British Nuclear Deterrent V Force","caption":"Historical photograph related to British Nuclear Deterrent V Force"},
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `British Nuclear Deterrent V Force`,
    description: `Comprehensive analysis of british nuclear deterrent v force with expert historical research and technical details.`,
    images: ['/blog-images/british-nuclear-deterrent-v-force-featured.jpg'],
    type: 'article'
  }
}
