...
const post = {
  ...
  content: `
      ...
      <div class="card-compact rounded-lg p-6 mb-8">
        <h3 class="text-lg font-semibold text-primary mb-4">📋 Article Contents</h3>
        <ul class="space-y-2">
          <li><a href="#origins-development" class=" hover:">1. Origins and Development (1934-1937)</a></li>
          <li><a href="#design-philosophy" class=" hover:">2. Design Philosophy and Innovation</a></li>
          <li><a href="#production-deployment" class=" hover:">3. Production and Deployment</a></li>
          <li><a href="#battle-britain" class=" hover:">4. Battle of Britain Service</a></li>
          <li><a href="#global-operations" class=" hover:">5. Global Operations and Variants</a></li>
          <li><a href="#technical-specifications" class=" hover:">6. Technical Specifications</a></li>
          <li><a href="#combat-effectiveness" class=" hover:">7. Combat Effectiveness Analysis</a></li>
          <li><a href="#pilot-accounts" class=" hover:">8. Pilot Accounts and Testimonies</a></li>
          <li><a href="#legacy-impact" class=" hover:">9. Legacy and Impact</a></li>
      </ul>
    </div>
      ...
      <div class="card-compact bg-accent-green text-white rounded-lg p-6 mb-8">
        <h3 class="text-lg font-semibold text-white mb-4">📚 Learn More in Our Books</h3>
