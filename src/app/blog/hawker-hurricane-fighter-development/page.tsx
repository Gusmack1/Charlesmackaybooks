...
export const metadata: Metadata = {
  title: 'Hawker Hurricane Fighter Development | Charles E. MacKay',
  description: 'Expert analysis and historical insights into Hawker Hurricane Fighter Development',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Hawker Hurricane Fighter Development'
      }
    ],
    locale: 'en_GB',
    type: 'article',
...
const post = {
  ...
  title: 'Hawker Hurricane Fighter Development',
  subtitle: 'Expert analysis and historical insights into Hawker Hurricane Fighter Development',
  content: `
    <div class="bg-amber-50 border-l-4 border-amber-400 p-6 mb-8">
      <p class="text-xl leading-relaxed text-gray-800 m-0">
        <strong>Aviation Excellence:</strong> Expert analysis and historical insights into Hawker Hurricane Fighter Development
      </p>
    </div>
  ...
  `,
  excerpt: 'Expert analysis and historical insights into Hawker Hurricane Fighter Development',
  author: {
  ...
  featuredImage: {
    url: '/blog-images/hawker-hurricane-fighter-development.jpg',
    alt: 'Hawker Hurricane Fighter Development',
    caption: 'Hawker Hurricane Fighter Development'
  },
  category: 'Aviation History',
  tags: ['Hawker Hurricane Fighter Development', 'Aviation History', 'Charles MacKay'],
  relatedBooks: [],
  relatedPosts: []
};
