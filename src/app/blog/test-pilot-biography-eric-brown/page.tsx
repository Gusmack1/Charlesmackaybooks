...
export const metadata: Metadata = {
  title: 'Test Pilot Biography Eric Brown | Charles E. MacKay',
  description: 'Expert analysis and historical insights into Test Pilot Biography Eric Brown',
  keywords: ['Test Pilot Biography Eric Brown', 'Aviation History', 'Charles MacKay'],
  openGraph: {
    ...
    images: [
      {
        url: '/blog-images/test-pilot-biography-eric-brown.jpg',
        width: 1200,
        height: 630,
        alt: 'Test Pilot Biography Eric Brown'
      }
    ],
    locale: 'en_GB',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Test Pilot Biography Eric Brown',
    description: 'Expert analysis and historical insights into Test Pilot Biography Eric Brown',
    images: ['/blog-images/test-pilot-biography-eric-brown.jpg'],
  },
}
...
const post = {
  ...
  title: 'Test Pilot Biography Eric Brown',
  subtitle: 'Expert analysis and historical insights into Test Pilot Biography Eric Brown',
  content: `
    <div class="bg-amber-50 border-l-4 border-amber-400 p-6 mb-8">
      <p class="text-xl leading-relaxed text-gray-800 m-0">
        <strong>Aviation Excellence:</strong> Expert analysis and historical insights into Test Pilot Biography Eric Brown
      </p>
    </div>
  ...
  `,
  excerpt: 'Expert analysis and historical insights into Test Pilot Biography Eric Brown',
  author: {
  ...
  featuredImage: {
    url: '/blog-images/test-pilot-biography-eric-brown.jpg',
    alt: 'Test Pilot Biography Eric Brown',
    caption: 'Test Pilot Biography Eric Brown'
  },
  category: 'Aviation History',
  tags: ['Test Pilot Biography Eric Brown', 'Aviation History', 'Charles MacKay'],
  relatedBooks: [],
  relatedPosts: []
};
