...
const post = {
  ...
  content: `
    ...
    <p>Brown’s portfolio differs from contemporaries who are better known for supersonic milestones or single‑programme breakthroughs. His achievement was breadth with depth: piston, jet, rocket, and rotorcraft, on land and at sea. In comparing records, one should keep roles in view. Brown’s unique value lay in converting risk across many types and environments into standardized, actionable doctrine. Others achieved singular speed or altitude; Brown built repeatable safety in places where the runway moved.</p>

    <h2 id="enemy-aircraft">Enemy Aircraft Evaluations: Turning Risk into Data</h2>
    <p>Brown's evaluations of captured enemy types were not museum pieces in waiting; they were tools for understanding how the adversary thought about stability, systems, and pilot workload. He recorded cold starts, taxying, takeoff behaviour, climb and acceleration, buffet cues, compressibility onset, stall progression, control harmony, and approach traits — always with an eye to reproducible notes. His work on rocket and jet types provided Allied engineers and tacticians with civil, unvarnished comparisons that improved training and counter‑tactics.</p>
    <p>
