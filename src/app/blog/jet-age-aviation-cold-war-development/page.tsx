...
const post = {
  ...
  content: `
    ...
    <div class="my-8">
      ...
      <p class="text-sm  mt-2 text-center italic">The English Electric Lightning F6, Britain's premier supersonic interceptor during the Cold War jet age.</p>
    </div>
    ...
    <div class="my-8">
      ...
      <p class="text-sm  mt-2 text-center italic">The Messerschmitt Me 262, the world's first operational jet fighter, which revolutionized aerial warfare during WWII.</p>
    </div>
    ...
    <div class="my-8">
      ...
      <p class="text-sm  mt-2 text-center italic">The North American F-86 Sabre, America's premier jet fighter during the Korean War and early Cold War period.</p>
    </div>
  ...
  featuredImage: {
    ...
    caption: 'Jet Age Aviation Cold War Development - Expert analysis by Charles E. MacKay'
  },
