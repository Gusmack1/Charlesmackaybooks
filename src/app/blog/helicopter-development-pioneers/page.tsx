...
export default function HelicopterDevelopmentPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <PageSEO
        title="Helicopter Development Pioneers: From Dreams to Reality | Charles E. MacKay"
        description="The pioneering engineers and visionaries who transformed helicopter development from experimental dream to practical reality, revolutionizing aviation."
        path="/blog/helicopter-development-pioneers"
        type="article"
      />
      <Header />
