...
const post = {
  ...
  content: `
    ...
    <p>
      The prototype development phase demonstrated the Me 262's revolutionary potential while revealing challenges that required resolution. The piston engine installation demonstrated the aircraft's basic airframe design, while the transition to turbojet power revealed the performance advantages that would define jet aviation. The documentation of prototype development documents the Me 262's evolution.
    </p>
    <p>
      Programme milestones included armament integration that optimized the aircraft for bomber interception. The four 30mm MK 108 cannon installation provided concentrated firepower essential for destroying heavy bombers. The documentation of armament development shows how the Me 262's combat capabilities are properly understood.
    </p>
    <p>
      Undercarriage refinement introduced tricycle gear that improved ground handling and pilot visibility. This innovation, while requiring longer runways than taildragger fighters, provided operational advantages that became standard for jet aircraft. The documentation of undercarriage development ensures that this innovation is properly recognized.
    </p>
    <p>
      The creation of specialist units (Kommando Nowotny, later Jagdgeschwader 7) developed operational tactics that maximized the Me 262's advantages while minimizing vulnerabilities. These units pioneered jet fighter doctrine that influenced post-war fighter development. The documentation of unit development ensures that tactical evolution is documented.
    </p>
    ...
    <p>
      The moderately swept wing design represented a compromise between aerodynamic efficiency and structural simplicity. While not as dramatically swept as post-war fighters, the Me 262's wing sweep delayed compressibility effects sufficiently to enable high-speed performance. The documentation of wing design shows how the Me 262's aerodynamic achievements are properly understood.
    </p>
    <p>
      Twin engines mounted below the wing simplified structural load paths and eased maintenance access. This configuration also kept hot engine sections clear of fuselage systems, reducing fire risk and simplifying cooling requirements. The documentation of engine installation documents the Me 262's design philosophy.
    </p>
    <p>
      The clean fuselage design minimized drag while providing space for fuel, armament, and avionics. This efficient packaging enabled the Me 262's exceptional performance while maintaining operational flexibility. The documentation of fuselage design shows how the Me 262's design excellence is properly recognized.
    </p>
    ...
    <p>
      The four 30mm MK 108 cannon installation provided concentrated firepower essential for destroying heavy bombers. The cannon's heavy hitting power compensated for low muzzle velocity in brief engagement windows. The documentation of armament development documents the Me 262's combat effectiveness.
    </p>
    <p>
      R4M rocket armament further enhanced the Me 262's effectiveness against bomber formations. Rocket salvos could disrupt formations before cannon passes, increasing kill probabilities. The documentation of rocket armament shows how the Me 262's weapons systems are properly understood.
    </p>
    ...
    <p>
      The book covers the development of the German piston aero-engine and Gas Turbines, including Jumo, BMW and Heinkel Hirth gas turbines. This comprehensive coverage demonstrates how German jet engine development supported Me 262 operations. Jumo 004 development shows how German jet engine technology enabled jet aircraft operations.
    </p>
    <p>
    ...
    <p>
      The Me 262's speed advantage at altitude was decisive in the abstract, enabling high-speed attacks that piston-engine fighters could not match. This speed advantage revolutionized fighter tactics, demonstrating how jet performance could overcome numerical disadvantages. The documentation of performance advantages shows how the Me 262's achievements are properly recognized.
    </p>
    <p>
      Acceleration and high-speed roll made the Me 262 a stable firing platform for brief attacks. The aircraft's stability at speed enabled accurate gunnery during high-speed passes. The documentation of handling characteristics documents the Me 262's operational effectiveness.
    </p>
    <p>
      Low-speed handling and runway requirements demanded precise piloting on approach and landing. The Me 262's tricycle undercarriage and high approach speeds required skilled piloting, particularly in adverse weather conditions. The documentation of low-speed handling ensures that operational challenges are properly understood.
    </p>
    ...
    <p>
      Jet bases required extended, smooth runways and well-practised flak corridors to cover climb-out. These requirements limited operational flexibility and created bottlenecks that Allied forces could exploit. The documentation of base requirements ensures that operational constraints are properly understood.
    </p>
    ...
    <p>
      Conversion courses emphasized throttle discipline, runway requirements, and tactical doctrine. Experienced fighter pilots transitioned to jets on compressed syllabi that focused on essential skills. The documentation of conversion training ensures that pilot experiences are properly understood.
    </p>
    <p>
      Veteran pilots praised the aircraft's stability at speed and the authority of thrust compared to dive-dependent energy management. This shift from dive-dependent to thrust-dependent tactics represented a fundamental change in fighter operations. The documentation of pilot experiences ensures that tactical evolution is documented.
    </p>
    <p>
      Pilots noted the penalty for mishandled throttles, the need for long, clean runways, and the vulnerability of approach and landing. These operational challenges required careful piloting and mission planning. The documentation of pilot experiences ensures that operational realities are properly preserved.
    </p>
    ...
    <p>
      Synthetic fuel production struggled under Allied bombing, creating fuel shortages that limited Me 262 operations. Despite advanced aircraft design, fuel availability determined operational effectiveness. The documentation of fuel shortages ensures that operational constraints are properly understood.
    </p>
    <p>
      Lubricant scarcity and alloy shortages shortened engine life, requiring cannibalization to maintain operational availability. These material constraints demonstrated how operational systems determine aircraft effectiveness. The documentation of material constraints ensures that operational realities are properly preserved.
    </p>
    <p>
      Dispersal to wooded revetments preserved airframes but complicated maintenance and spares distribution. This dispersal strategy protected aircraft from Allied attacks but created logistical challenges that limited sortie rates. The documentation of dispersal operations ensures that operational trade-offs are properly understood.
    </p>
    ...
    <p>
      Escort fighters loitered near known jet fields, exploiting vulnerability windows during take-off and landing. These tactics demonstrated how operational systems could counter technological advantages. The documentation of Allied tactics ensures that operational realities are properly understood.
    </p>
    <p>
      Once airborne and fast, the Me 262 was difficult to intercept, demonstrating the aircraft's performance advantages. Decisive combats clustered around base perimeters and choke points, where operational systems rather than pure performance determined outcomes. The documentation of combat patterns ensures that operational realities are properly preserved.
    </p>
    ...
    <p>
      ...
      which provides detailed analysis of how advanced aircraft operated within a collapsing system. The documentation of 1945 operations ensures that operational realities are properly preserved.
    </p>
    ...
    <p>
      Post-war studies translated Me 262 lessons into early Cold War design practice. Swept-wing aerodynamics, engine integration, and operational doctrine influenced fighter design for decades. The documentation of post-war influence shows how the Me 262's contribution to aviation development is properly recognized.
    </p>
    <p>
    ...
    <p>
      The Me 262's legacy continues in modern fighter design, where jet propulsion, advanced aerodynamics, and integrated systems define combat aircraft capabilities. The principles established through the Me 262's development continue to influence fighter design. The documentation of this legacy shows how the Me 262's historical significance is properly preserved.
    </p>
    <p>
      Modern fighters continue to incorporate principles established by the Me 262: high-speed performance, thrust-dependent tactics, and integrated weapons systems. The documentation of this continuity shows how the Me 262's influence on modern aviation is properly recognized.
    </p>
