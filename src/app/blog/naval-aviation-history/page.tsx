...
const blogData = {
  ...
  featuredImage: {"url":"/blog-images/naval-aviation-history-featured.jpg","alt":"Featured image for Naval Aviation History","caption":"Historical photograph related to Naval Aviation History"},
