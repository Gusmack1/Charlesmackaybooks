...
const post = {
  ...
  content: `
    ...
    <div class="my-8">
      ...
      <p class="text-sm text-gray-600 mt-2 text-center italic">The Bristol Sycamore, Britain's first helicopter to enter military service, which pioneered military rotorcraft operations.</p>
    </div>
    ...
    <div class="my-8">
      ...
      <p class="text-sm text-gray-600 mt-2 text-center italic">The Sikorsky VS300, the breakthrough helicopter that established modern rotorcraft design principles for military applications.</p>
    </div>
    ...
    <div class="my-8">
      ...
      <p class="text-sm text-gray-600 mt-2 text-center italic">Military helicopter formations demonstrating the evolution of rotorcraft tactics and operational procedures.</p>
    </div>
