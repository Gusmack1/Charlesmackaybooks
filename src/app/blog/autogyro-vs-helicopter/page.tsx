...
const post = {
  ...
  content: `
    ...
    <p>
      This Enhanced Edition draws on <a href="/books/sycamore-seeds" class="underline font-medium">The Sycamore Seeds</a> to provide a comprehensive technical comparison of autogyros and helicopters, examining their aerodynamic differences, control systems, applications, and legacy. the relationship between autogyros and helicopters shows the evolution of vertical flight technology and the engineering principles that enabled practical rotorcraft development.
    </p>
    <p>
