...
export const metadata: Metadata = {
  ...
  description: 'Expert analysis and historical insights into Supermarine Spitfire Development Evolution',
  keywords: ['Supermarine Spitfire Development Evolution', 'Aviation History', 'Charles MacKay'],
  openGraph: {
    ...
    images: [
      {
        url: '/blog-images/supermarine-spitfire-development-evolution.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Supermarine Spitfire Development Evolution',
    description: 'Expert analysis and historical insights into Supermarine Spitfire Development Evolution',
    images: ['/blog-images/supermarine-spitfire-development-evolution.jpg'],
  },
}
...
const post = {
  ...
  title: 'Supermarine Spitfire Development Evolution',
  subtitle: 'Expert analysis and historical insights into Supermarine Spitfire Development Evolution',
  content: `
    <div class="bg-amber-50 border-l-4 border-amber-400 p-6 mb-8">
      <p class="text-xl leading-relaxed text-gray-800 m-0">
        <strong>Aviation Excellence:</strong> Expert analysis and historical insights into Supermarine Spitfire Development Evolution
      </p>
    </div>
  ...
  `,
  excerpt: 'Expert analysis and historical insights into Supermarine Spitfire Development Evolution',
  author: {
  ...
  featuredImage: {
    url: '/blog-images/supermarine-spitfire-development-evolution.jpg',
    alt: 'Supermarine Spitfire Development Evolution',
    caption: 'Supermarine Spitfire Development Evolution'
  },
  category: 'Aviation History',
  tags: ['Supermarine Spitfire Development Evolution', 'Aviation History', 'Charles MacKay'],
  relatedBooks: [],
  relatedPosts: []
};
