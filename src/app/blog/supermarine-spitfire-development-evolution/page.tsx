...
const post = {
  ...
  content: `
    ...
    <p>Late‑war variants brought increases in power and capability supported by incremental structural and systems changes. The aerodynamic discipline established at the outset made these changes tractable. Pilots still reported the qualities that defined the type: predictable behaviour near the limits and a sense that the aircraft responded as an extension of intent.    </p>
    ...
    <p>Surface finish quality and corrosion vigilance preserved aerodynamic assumptions over service life. Rivet flushness, puttied seams where appropriate, and clean paint ensured that boundary‑layer behaviour matched design intent. In maritime and coastal climates, thorough washing, inspection of joints, and sealing of vulnerable intersections prevented corrosion from eroding safety margins or distorting surface quality. The connection between shop practice and flight performance remained visible throughout the programme.</p>
    ...
    <ul>
      <li>Elliptical planform aimed at near‑ideal lift distribution with practical allowances for structure and armament, protecting induced‑drag assumptions while enabling benign stall behaviour.</li>
