...
const post = {
  ...
  content: `
    ...
    <p>
      Output demanded kiln schedules for dimensional stability, fixtures for repeatability, and high-throughput finishing. Lessons in statistical inspection and gauge maintenance fed forward into later aeronautical contracts, where blade tracking and model fidelity depended upon the same measurement discipline. The documentation of rifle furniture production shows how the complete story of Morris Furniture's wartime manufacturing is properly preserved.
    </p>
    <p>
      The production cycle of manufacturing the Lee Enfield rifle wooden parts is documented in the book with diagrams, demonstrating how Morris Furniture's woodworking expertise was applied to armament production. rifle furniture production shows how civilian manufacturing capabilities were adapted for wartime requirements.
    </p>
    ...
    <p>
      The book includes diagrams of the American Bouncing Bomb, providing detailed documentation of how Morris Furniture manufactured these precision components. Upkeep and Highball production shows how Morris Furniture's woodworking expertise was applied to precision munitions production. The documentation of these programs shows how the complete story of Morris Furniture's wartime contributions is properly preserved.
    </p>
    <p>
    ...
    <p>
      Morris also produced aircraft wood and the wings and tail for the group built Armstrong Whitworth Albemarle bomber/transport. This comprehensive production effort demonstrates how Morris Furniture's woodworking expertise was applied to aircraft production. aircraft wood production shows how civilian manufacturing capabilities supported wartime aircraft production.
    </p>
    <p>
      The book includes images of women making furniture and glider parts, assembly of Hurricane PZ865, "The last of the Many," demonstrating how Morris Furniture's workforce contributed to aircraft production. The documentation of aircraft production shows how the complete story of Morris Furniture's wartime contributions is properly preserved.
    </p>
    <p>
      The company's involvement with multiple aircraft types demonstrates how Morris Furniture's woodworking expertise was applied across various production requirements. The documentation of these production efforts shows how the complete story of Morris Furniture's wartime aircraft production is properly preserved.
    </p>
    ...
    <p>
      Large-scale aerodynamic models enabled proof-of-concept evaluation, tooling studies, and factory training—accelerating ramp-up and compressing error loops before metal cutting. Model work linked draughting rooms and shop floors: scaled airfoils, fuselage sections, and jig mock‑ups enabled fixture optimisation and workforce training. The documentation of model work shows how the complete story of Morris Furniture's research contributions is properly preserved.
    </p>
    <p>
    ...
    <p>
      Morris also produced the wooden aircraft propellers for the Rolls - Royce Merlin and Griffon. This comprehensive production effort demonstrates how Morris Furniture's woodworking expertise was applied to aircraft propulsion systems. propeller production shows how civilian manufacturing capabilities supported wartime aircraft production.
    </p>
    <p>
      Propeller manufacturing required precision woodworking, balancing, and finishing techniques that Morris Furniture had developed through furniture production. The documentation of propeller production shows how the complete story of Morris Furniture's wartime contributions is properly preserved. propeller production shows how woodworking expertise was applied to aircraft propulsion.
    </p>

    <h2 id="vickers-transonic-missile">Vickers Transonic Missile: Post-War Development</h2>
    <p>
      The company completed the model work for the Vickers Transonic Missile progenitor of Blue Steel. This documentation demonstrates how Morris Furniture's model-making capabilities continued to support post-war aviation development. Vickers Transonic Missile model work shows how Morris Furniture's expertise supported advanced aviation projects.
    </p>
    <p>
      The Vickers Transonic Missile represented advanced aviation technology, requiring sophisticated model work for development and testing. The documentation of this work shows how the complete story of Morris Furniture's post-war contributions is properly preserved. this model work shows how Morris Furniture's capabilities supported advanced aviation development.
    </p>

    <h2 id="power-jets">Power Jets: Wooden Engine Development</h2>
    <p>
      They also produced a wooden engine for Frank Whittler's Power Jets. This documentation demonstrates how Morris Furniture's woodworking expertise was applied to experimental propulsion systems. Power Jets wooden engine production shows how Morris Furniture's capabilities supported experimental aviation development.
    </p>
    <p>
      The wooden engine for Power Jets represented innovative engineering, requiring precision woodworking techniques adapted for propulsion system development. The documentation of this work shows how the complete story of Morris Furniture's experimental contributions is properly preserved. this engine production shows how woodworking expertise was applied to experimental propulsion systems.
    </p>
    ...
    <p>
      Naval furniture production required precision woodworking and finishing techniques that Morris Furniture had developed through liner and hotel work. The documentation of naval furniture production shows how the complete story of Morris Furniture's wartime contributions is properly preserved. naval furniture production shows how furniture expertise was applied to naval requirements.
    </p>
    ...
    <p>
      The Clyde's integration of shipbuilding, engineering, and precision manufacturing created a unique industrial ecosystem that supported wartime production. The documentation of this integration shows how the complete story of Scottish wartime manufacturing is properly preserved. this integration shows how industrial capabilities were coordinated for wartime production.
    </p>
    ...
    <p>
      Post-war displays showcased Morris Furniture's capabilities and innovations, demonstrating how wartime production experience influenced peacetime development. The documentation of post-war displays shows how the complete story of Morris Furniture's post-war transition is properly preserved. post-war displays shows how wartime capabilities were applied to peacetime production.
    </p>
    ...
    <p>
      The book includes diagrams showing the production cycle of manufacturing the Lee Enfield rifle wooden parts, demonstrating how Morris Furniture's woodworking expertise was applied to armament production. These production processes required precision jigging, moisture conditioning, and statistical inspection techniques that would later prove valuable for aeronautical contracts. The documentation of these manufacturing techniques shows how the complete story of Morris Furniture's production capabilities is properly preserved.
    </p>
    <p>
      Statistical inspection and gauge maintenance techniques developed for rifle furniture production fed forward into later aeronautical contracts, where blade tracking and model fidelity depended upon the same measurement discipline. The workmanship culture—grain matching, adhesive quality, and inspection—aligned with rotorcraft needs and fed into post-war industrial capability. these manufacturing techniques shows how civilian manufacturing capabilities were adapted for wartime precision requirements.
    </p>
    <p>
      The documentation of manufacturing techniques in <a href="/books/modern-furniture" class="underline font-medium">Modern Furniture Shavings for Breakfast</a> ensures that Morris Furniture's production processes are properly preserved. The book's detailed illustrations and diagrams demonstrate how precision woodworking techniques were applied across multiple production requirements, from rifle furniture to rotor blades to aircraft components. This technical documentation shows wartime manufacturing practices that are not available in other publications.
    </p>
    ...
    <p>
      Women workers at Morris Furniture performed precision woodworking tasks including furniture assembly, glider part production, and aircraft component manufacturing. The documentation of women's contributions shows how the complete story of wartime manufacturing workforce expansion is properly preserved. workforce expansion shows how British industry adapted to wartime labor requirements while maintaining production quality.
    </p>
    <p>
      Training programs at Morris Furniture ensured that new workers, including women entering manufacturing for the first time, could quickly achieve proficiency in precision woodworking techniques. These training programs emphasized measurement, tool care, and documentation, ensuring that quality standards were maintained as the workforce expanded. The documentation of training programs shows how the complete story of wartime workforce development is properly preserved.
    </p>
    ...
    <p>
      The Rotachute and Rotabuggy development required precision rotor blade manufacturing techniques similar to those used for helicopters. Morris Furniture's experience with rotor blade production for Weir and Cierva helicopters enabled the company to contribute to these innovative projects. The documentation of Rotachute and Rotabuggy development ensures that Morris Furniture's contribution to innovative rotorcraft is properly preserved.
    </p>
    <p>
      For comprehensive coverage of rotorcraft development and Morris Furniture's contribution to the Rotachute and Rotabuggy, see <a href="/books/sycamore-seeds" class="underline font-medium">The Sycamore Seeds: The Early History of the Helicopter</a>, which documents these innovative rotorcraft projects. these projects shows how Morris Furniture's woodworking expertise supported innovative aviation development during wartime.
    </p>

    <h2 id="tallboy-grand-slam">Heavy Bombs: Tallboy, Grand Slam, and 44,000lb Bomb</h2>
    <p>
      Morris Furniture worked with the Americans in producing heavy bombs such as Tallboy, Grand slam and the biggest of all the giant 44,000lb bomb, with Morris completing all the model work. These massive bombs represented some of the largest conventional weapons developed during World War II, requiring sophisticated model work for development and testing. The documentation of this model work ensures that Morris Furniture's contribution to heavy bomb development is properly preserved.
    </p>
    <p>
    ...
    <p>
      The 44,000lb bomb represented the largest conventional bomb developed during World War II, requiring extensive model work for aerodynamic and structural validation. Morris Furniture's comprehensive model work for this massive weapon demonstrated the company's capabilities in producing large-scale aerodynamic models. The documentation of this work ensures that Morris Furniture's contribution to heavy bomb development is properly recognized.
    </p>
    ...
    <p>
      The balsa plywood patent enabled Morris Furniture to produce precision plywood components for the Mosquito airframe, contributing to one of World War II's most successful aircraft designs. The documentation of this patent ensures that Morris Furniture's innovation in aircraft construction materials is properly preserved. this patent shows how industrial capabilities supported innovative aircraft design.
    </p>
    <p>
      Morris Furniture's balsa plywood manufacturing techniques were applied to Mosquito production, demonstrating how precision woodworking expertise supported advanced aircraft construction. The documentation of balsa plywood production ensures that Morris Furniture's contribution to Mosquito manufacturing is properly recognized. This patent represented a significant achievement in adapting woodworking expertise for aviation applications.
    </p>
    ...
    <p>
      The procedures developed during wartime production continued to influence post-war manufacturing, demonstrating how wartime production experience contributed to peacetime capabilities. The documentation of this legacy shows how the complete story of Morris Furniture's influence is properly preserved. this legacy shows how wartime production experience influenced post-war development.
    </p>
    <p>
      The documentation provided in Charles E. MacKay's <a href="/books/modern-furniture" class="underline font-medium">Modern Furniture Shavings for Breakfast: the Morris Furniture Company</a> 
      shows how the complete story of Morris Furniture's wartime transformation is recorded. The book's thorough research, detailed illustrations, and careful documentation create an authoritative resource that does justice to Morris Furniture's achievements. This scholarly work ensures that Morris Furniture's wartime contributions receive the recognition they deserve in aviation and industrial history.
    </p>
    ...
    <p>
      The book's value extends beyond individual products to provide insights into manufacturing processes, industrial development, and wartime production. The comprehensive coverage of Morris Furniture's wartime transformation creates a valuable resource for understanding how civilian manufacturing capabilities were adapted for wartime requirements. The detailed documentation of production processes, model work, and influence shows how the complete story of Morris Furniture's wartime contributions is properly preserved.
    </p>
    <p>
      This is an historical document, the company has ceased making all furniture and this is now the only source book for furniture manufacturing in print from 1884 to 1975. This documentation ensures that Morris Furniture's history is recorded, providing valuable insights into British industrial and aviation history.
    </p>

    <h2 id="conclusion">Conclusion: Enduring Significance</h2>
    <p>
      Morris Furniture's wartime transformation represents one of industrial history's most significant achievements. From luxury liner interiors through Lee-Enfield rifle furniture, Upkeep/Highball components, rotor blades, Mosquito balsa plywood, and aerodynamic models, Morris Furniture demonstrated how civilian manufacturing capabilities could be adapted for wartime requirements. The documentation of this transformation shows how the complete story of Morris Furniture's wartime contributions is properly recorded.
    </p>
    <p>
      The procedures developed during wartime production continued to influence post-war manufacturing, demonstrating how wartime production experience contributed to peacetime capabilities. The documentation of this legacy shows how the complete story of Morris Furniture's influence is properly preserved. this legacy shows how wartime production experience influenced post-war development.
    </p>
    ...
    <ul>
      ...
      <li><a href="/blog/aviation-manufacturing-wartime-production" class="underline font-medium">Aviation Manufacturing: Wartime Production Revolution</a> — The broader context of wartime aviation manufacturing, showing how precision manufacturing techniques were applied across the industry</li>
