...
const post = {
  ...
  content: `
    ...
    <p>
      The book <a href="/books/clydeside-aviation-vol1" class="underline font-medium">Clydeside Aviation Volume One</a> provides a detailed description of the history of Aviation on Clydeside from 1785 to 1919. This comprehensive 372-page work profusely illustrated with over 450 illustrations and drawings commences with the balloonist Vincent Lunardi of 1785 in Glasgow, then Percy Pilcher flying at Cardross. The book includes fresh details of Pilcher and his flights at Cardross and his death flight, A. B. Baird and his monoplane on the Isle of Bute and Harold and Frank Barnwell at Grampian Motor Works, Stirling. This documentation ensures that Clydeside aviation development is documented within the broader context of Scottish industrial history.
    </p>
    <p>
    ...
    <p>
      The book commences with the balloonist Vincent Lunardi of 1785 in Glasgow, establishing the earliest foundations of Scottish aviation. This early balloon activity demonstrates how Scotland's aviation heritage extends back to the very beginnings of human flight. The documentation of early aviation ensures that Clydeside's aviation origins are properly understood.
    </p>
    <p>
      There are fresh details of Percy Pilcher and his flights at Cardross and his death flight. Pilcher's pioneering work represents Scotland's earliest systematic aviation experiments, demonstrating how Scottish engineering expertise supported early aviation development. The documentation of Pilcher's work ensures that his contributions to Scottish aviation are properly recognized.
    </p>
    <p>
      A. B. Baird and his monoplane on the Isle of Bute and Harold and Frank Barnwell at Grampian Motor Works, Stirling represent additional early Scottish aviation pioneers. These pioneers demonstrate how Scottish engineering expertise supported early aircraft development. The documentation of these pioneers shows how their contributions are properly preserved.
    </p>
    <p>
    ...
    <p>
      The book documents the industrial situation of spring 1915, the strikes and the conflict with the trade unions is fully explained. This is an insight into the beginnings of "Red Clydeside." This comprehensive coverage demonstrates how industrial relations influenced aviation production. these industrial relations shows how Scottish aviation manufacturing developed.
    </p>
    <p>
      The documentation of the industrial ecosystem ensures that Clydeside's transformation is documented. The integration of steel production, machining, and shipbuilding expertise created a unique aviation manufacturing capability.
    </p>
    ...
    <p>
      The book describes the Wartime Weir Scheme of aeroplane production explored in-depth with histories of the scheme members and their ships, including Denny of Dumbarton, Weir, Barclay Curle, Stephen of Linthouse, Fairfield at Govan, The North British Locomotive Works at Springburn, Napier and Miller, Old Kilpatrick, Corporation of Glasgow Tramways Department and Bostock's Zoo at New City Road. This comprehensive coverage demonstrates how shipbuilding companies transformed into aviation manufacturers. this transformation shows how industrial capabilities were adapted for aviation.
    </p>
    ...
    <p>
      There are detailed accounts of the aircraft in service with the Royal Flying Corps and the Royal Navy. This comprehensive coverage ensures that operational deployment is documented. operational deployment shows how Clydeside aircraft contributed to wartime operations.
    </p>
    <p>
    ...
    <p>
      The book describes Beardmore Aviation's production of Sopwith Pup and Sopwith Camel aircraft, demonstrating how Scottish manufacturers contributed to fighter production. The documentation of Beardmore production ensures that Scottish manufacturing contributions are properly recognized.
    </p>
    ...
    <p>
      ...
      which provides detailed analysis of Beardmore's airship programme and its contribution to British airship development. The documentation of airship production ensures that Scottish contributions are properly recognized.
    </p>
    ...
    <p>
      The book describes the use of Belgian Refugees is included for the first time in any aeronautical publication, as is the successful introduction of women into the aircraft manufacturing process. Descriptions of their work are fully described. This comprehensive coverage demonstrates how wartime labor requirements influenced aviation production. labor contributions shows how Scottish aviation manufacturing scaled during wartime.
    </p>
    <p>
      The documentation of wartime mobilization ensures that production scaling is documented. The successful integration of refugee workers and women into aviation production demonstrates how Scottish manufacturers adapted to wartime requirements.
    </p>
    ...
    <p>
      The book documents the development of Renfrew airport by the Ministry of Munitions and the landing ground at Cumnock. This comprehensive coverage demonstrates how aviation infrastructure supported production. infrastructure development shows how Scottish aviation manufacturing was supported.
    </p>
    <p>
      The documentation of workforce development ensures that technical culture is documented. The integration of women and refugee workers into aviation production demonstrates how Scottish manufacturers adapted to wartime requirements.
    </p>
    ...
    <p>
      The documentation of tooling and metrology ensures that manufacturing quality is documented. The systematic approach to quality control demonstrated how Scottish manufacturers adapted naval inspection practices to aviation production.
    </p>
    ...
    <p>
      The book documents the Beardmore Halford Pullinger (B.H.P.) aero engine built by Weir and substantial details of it are included. Details are included for the Ferdinand Porsche designed Beardmore Austro Daimler. This comprehensive coverage demonstrates how Scottish manufacturers contributed to engine development. engine production shows how Scottish industrial capabilities supported aviation powerplant manufacturing.
    </p>
    ...
    <p>
      The documentation of logistics ensures that production systems are properly understood. The integration of rail, river, and road transport demonstrates how Scottish manufacturers leveraged existing infrastructure for aviation production.
    </p>
    ...
    <p>
      The documentation of comparisons ensures that Clydeside's advantages are properly understood. The systems integration approach demonstrated how Scottish manufacturers leveraged existing capabilities for aviation production.
    </p>
    ...
    <p>
      The book provides histories of the scheme members and their ships, including Denny of Dumbarton, Weir, Barclay Curle, Stephen of Linthouse, Fairfield at Govan, The North British Locomotive Works at Springburn, Napier and Miller, Old Kilpatrick, Corporation of Glasgow Tramways Department and Bostock's Zoo at New City Road. This comprehensive coverage demonstrates how diverse companies contributed to aviation production. company-level contributions shows how Scottish aviation manufacturing developed.
    </p>
    <p>
      For comprehensive coverage of Beardmore Aviation, see 
      <a href="/books/beardmore-aviation" class="underline font-medium">Beardmore Aviation</a>, 
      which provides detailed analysis of William Beardmore & Company's aviation activities and aircraft production. The documentation of Beardmore ensures that Scottish aviation manufacturing contributions are properly preserved.
    </p>
    ...
    <p>
      The documentation of standards and airworthiness ensures that quality systems are properly understood. The systematic approach to documentation demonstrated how Scottish manufacturers adapted naval inspection practices to aviation production.
    </p>
    ...
    <p>
      The book documents Beardmore's production of Sopwith Pup and Sopwith Camel aircraft, demonstrating how Scottish manufacturers contributed to fighter production. The documentation of Beardmore production ensures that Scottish manufacturing contributions are properly recognized.
    </p>
    <p>
      For comprehensive coverage of Beardmore Aviation, see 
      <a href="/books/beardmore-aviation" class="underline font-medium">Beardmore Aviation</a>, 
      which provides detailed analysis of William Beardmore & Company's aviation activities from 1913 to 1930, including aircraft production, aero engines, airships, and HMS Argus. The documentation of Beardmore ensures that Scottish aviation manufacturing contributions are properly preserved.
    </p>
    ...
    <p>
      The successful integration of refugee workers and women into aviation production demonstrates how Scottish manufacturers adapted to wartime requirements. The documentation of labor contributions shows how these important contributions are properly preserved.
    </p>
    ...
    <p>
      ...
      <a href="/books/clydeside-aviation-vol1" class="underline font-medium">Clydeside Aviation Volume One: The Great War</a> 
      and <a href="/books/beardmore-aviation" class="underline font-medium">Beardmore Aviation</a> 
      ensures that this remarkable transformation is recorded.
    </p>
    <p>
