    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'RFC pilots of No. 32 Squadron with their aircraft in 1916 showing the British military aviation development during WWI'
      }
    ],
    locale: 'en_GB',
    type: 'article',
