...
const post = {
  ...
  content: `
    ...
    <p>The Falcon V‑12 provided the decisive margin: robust power delivery, responsive throttle, and dependable cooling when cowlings and shutters were managed correctly. Unit practices covered plug inspection, coolant checks, and radiator care; hot‑weather operations demanded attention to mixture and climb schedules. The engine’s reliability underpinned offensive tactics, allowing confident dives and climbs back to altitude.</p>
    ...
    <p>Forward armament comprised a synchronized Vickers gun aligned to deliver stable fire at convergence. Aft, one or two Lewis guns on the Scarff ring covered the upper rear hemisphere. Ammunition management — belt care and drum changes — was drilled. The intent was unity of action: the pilot pressed attacks; the observer controlled the geometry astern, denying enemy aircraft preferred approach arcs.</p>
    ...
    <p>Operational squadrons transitioned from defensive patterns to aggressive tactics during 1917. Early losses taught the core lesson: fly it like a fighter. Subsequent formation SOPs and briefing cards encoded best practice — a cultural shift that transformed results within months.</p>
    ...
    <p>The Brisfit’s achievement lies in integration: airframe agility, reliable power, coordinated armament, trained crews, and maintainable structure. Its record stands as a study in how concept, engineering, and operations combine to create combat power — a lesson with modern relevance wherever multi‑role aircraft and crew coordination determine outcomes.</p>
  `,
