...
export default function CheckoutPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-[#020221] flex items-center justify-center">
    ...
    <div className="min-h-screen bg-[#020221]">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-8">
          ...
          <div>
            {step === 'basket' && (
              <div className="bg-[#020221]/90 border border-blue-700/50 rounded-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold mb-4 text-white">Your Basket</h2>
                <div className="space-y-3 sm:space-y-4">
                  {items.map((item, index) => (
                    <div key={index} className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 border border-blue-700/50 rounded-lg bg-[#020221]/60">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2 sm:p-3 border border-blue-600 rounded-lg text-white bg-[#020221]/50 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 placeholder:text-white/50"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="mt-3 sm:mt-4">
                  ...
                  <select
                    ...
                    onChange={(e) => handleInputChange('country', e.target.value)}
                      className="w-full p-2 sm:p-3 border border-blue-600 rounded-lg text-white bg-[#020221]/50 focus:border-blue-400 focus:ring-1 focus:ring-blue-400"
                    required
                  >
          ...
          <div className="lg:sticky lg:top-8 space-y-4 sm:space-y-6">
              ...
              {/* Security Notice */}
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-[#020221]/50 border border-blue-700/50 rounded-lg">
