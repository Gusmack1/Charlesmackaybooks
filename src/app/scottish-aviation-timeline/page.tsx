            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {eras.map((era) => (
                <button
                  ...
                  className={`relative overflow-hidden rounded-xl p-6 text-white font-semibold transition-all duration-300 transform hover:scale-105 ${
                    selectedEra === era ? 'ring-4 ring-blue-400 scale-105' : ''
                  }`}
                  style={{
                    background: `linear-gradient(135deg, ${eraColors[era as keyof typeof eraColors].split(' ')[1]} 0%, ${eraColors[era as keyof typeof eraColors].split(' ')[3]} 100%)`
                  }}
                >
