...
export const metadata: Metadata = {
  ...
  keywords: bookData.tags?.join(', ') || 'Aircraft Carrier Argus',
  openGraph: {
...
export default function BookPage() {
  const description = "Comprehensive study of Aircraft Carrier Argus with expert analysis and historical context";
