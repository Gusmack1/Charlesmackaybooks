...
const book = books.find(b => b.id === 'aircraft-carrier-argus')!

export const metadata: Metadata = {
  title: book.title + " | Charles E. MacKay Aviation Books",
  description: "The story of HMS Argus, Britain's first true aircraft carrier. Discover how this converted liner pioneered naval aviation and laid the foundations for modern carrier operations.",
  openGraph: {
    title: book.title + " | Charles E. MacKay Aviation Books",
    description: "The story of HMS Argus, Britain's first true aircraft carrier. Discover how this converted liner pioneered naval aviation and laid the foundations for modern carrier operations.",
    type: 'website',
    images: [
      {
        url: book.imageUrl || '/book-covers/aircraft-carrier-argus.jpg',
        width: 1200,
        height: 630,
...
const jsonLd = {
  ...
  author: {
    ...
    description: 'Aviation historian specializing in naval aviation and aircraft carrier development',
  ...
  image: book.imageUrl || '/book-covers/aircraft-carrier-argus.jpg',
  ...
  keywords: book.tags?.join(', ') || 'HMS Argus, Aircraft Carrier, Naval Aviation',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://charlesmackaybooks.com/books/aircraft-carrier-argus'
  }
}

export default function AircraftCarrierArgusPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <Image
                  src={book.imageUrl || '/book-covers/aircraft-carrier-argus.jpg'}
                  alt={`${book.title} by Charles E. MacKay`}
                  width={450}
                  height={675}
            ...
            <div>
              <div className="text-sm text-blue-300 mb-3 flex items-center gap-2">
                <span>Naval Aviation History</span>
                <span>•</span>
                <span>Aircraft Carrier Development</span>
                <span>•</span>
                <span>HMS Argus</span>
              </div>
