...
const book = books.find(b => b.id === 'enemy-luftwaffe-1945')!
...
const jsonLd = {
  ...
  isbn: book.isbn,
  isbn10: '1838056785',
  isbn13: '9781838056785',
  numberOfPages: book.pageCount,
  datePublished: book.publicationYear?.toString() || '2022',
  author: {
    '@type': 'Person',
    name: 'Charles E. MacKay',
    description: 'Aviation historian specializing in WWII aviation and Luftwaffe operations',
  ...
  image: book.imageUrl || '/book-covers/enemy-luftwaffe-1945.jpg',
  genre: 'WWII Aviation History',
  about: [
    'Luftwaffe 1945',
    'German Air Force Collapse',
    'WWII Final Year Aviation',
    'German Aircraft Development',
    'Late War German Aviation'
  ],
  keywords: book.tags?.join(', ') || 'Luftwaffe, WWII, German Aviation, 1945',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://charlesmackaybooks.com/books/enemy-luftwaffe-1945'
  }
}

export default function EnemyLuftwaffe1945Page() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-slate-900 via-gray-800 to-black text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <Image
                  src={book.imageUrl || '/book-covers/enemy-luftwaffe-1945.jpg'}
            ...
            <div>
              <div className="text-sm text-gray-300 mb-3 flex items-center gap-2">
                <span>WWII Aviation</span>
                <span>•</span>
                <span>Luftwaffe History</span>
                <span>•</span>
                <span>1945 Final Year</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 text-center">
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <div className="text-lg font-semibold">9781838056785</div>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
              ...
              <div className="space-y-4">
                <div className="grid gap-4">
                  ...
                  <button
                    ...
                    className="w-full bg-gray-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-700 transition-colors text-center"
                  >
                    🛒 Buy Now on eBay
                  </button>
