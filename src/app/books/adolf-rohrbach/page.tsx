...
export default function BookPage() {
  const description = "Biography of Adolf Rohrbach, the pioneering German aircraft designer who revolutionized metal aircraft construction and influenced aviation design worldwide.";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-center items-center gap-4 text-sm">
            ...
            <div className="flex gap-3">
              <a 
                href={`https://facebook.com/sharer/sharer.php?u=https://charlesmackaybooks.com/books/adolf-rohrbach`}
                target="_blank" 
              ...
              <a 
                href={`https://twitter.com/intent/tweet?url=https://charlesmackaybooks.com/books/adolf-rohrbach&text=${bookData.title}`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
              ...
              <a 
                href={`https://linkedin.com/sharing/share-offsite/?url=https://charlesmackaybooks.com/books/adolf-rohrbach`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <Image
                  src={bookData.imageUrl || `/book-covers/adolf-rohrbach.jpg`}
                  alt={bookData.title}
                  width={400}
                  height={600}
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-4 not-prose">
                <Link href="/blog/adolf-rohrbach-metal-aircraft-construction" className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200">
                  <h4 className="font-semibold text-blue-600">adolf rohrbach metal aircraft construction</h4>
