...
import SEOIndexingFix from '@/components/SEOIndexingFix'
...
export default function BeardmoreAviationPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <SEOIndexingFix
        pageUrl="https://charlesmackaybooks.com/books/beardmore-aviation"
              ...
              <div className="space-y-4">
                <div className="grid gap-4">
                  ...
                  <button
                    ...
                    className="w-full bg-purple-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-700 transition-colors text-center"
                  >
                    🛒 Buy Now on eBay
                  </button>
                  <button className="w-full border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-50 hover:text-purple-800 transition-colors">
