...
export default function BookPage() {
  const description = "The definitive account of William Beardmore & Company ambitious venture into aviation manufacturing, from early experiments at Dalmuir to the tragic loss of R101.";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-center items-center gap-4 text-sm">
            ...
            <div className="flex gap-3">
              <a 
                href={`https://facebook.com/sharer/sharer.php?u=https://charlesmackaybooks.com/books/beardmore-aviation`}
                target="_blank" 
              ...
              <a 
                href={`https://twitter.com/intent/tweet?url=https://charlesmackaybooks.com/books/beardmore-aviation&text=${bookData.title}`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
              ...
              <a 
                href={`https://linkedin.com/sharing/share-offsite/?url=https://charlesmackaybooks.com/books/beardmore-aviation`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <Image
                  src={bookData.imageUrl || `/book-covers/beardmore-aviation.jpg`}
                  alt={bookData.title}
                  width={400}
                  height={600}
