...
const book = books.find(b => b.id === 'modern-furniture')!
...
const jsonLd = {
  ...
  author: {
    ...
    description: 'Author and historian specializing in Scottish industrial history',
  ...
  image: book.imageUrl || '/book-covers/modern-furniture.jpg',
  ...
  keywords: book.tags?.join(', ') || 'Modern Furniture, Manufacturing, Scottish Industry',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://charlesmackaybooks.com/books/modern-furniture'
  }
}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <Image
                  src={book.imageUrl || '/book-covers/modern-furniture.jpg'}
            ...
            <div>
              <div className="text-sm text-amber-300 mb-3 flex items-center gap-2">
                <span>Industrial History</span>
                <span>•</span>
                <span>Manufacturing</span>
                <span>•</span>
                <span>Scottish Industry</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 text-center">
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  <div className="text-sm text-amber-300 mb-1">ISBN</div>
