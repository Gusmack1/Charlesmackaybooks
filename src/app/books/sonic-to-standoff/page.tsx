...
const book = books.find(b => b.id === 'sonic-to-standoff')!
...
const jsonLd = {
  ...
  isbn: book.isbn,
  isbn10: '1838056794',
  isbn13: '9781838056794',
  numberOfPages: book.pageCount,
  datePublished: book.publicationYear?.toString() || '2023',
  author: {
    '@type': 'Person',
    name: 'Charles E. MacKay',
    description: 'Aviation historian specializing in Cold War aviation and nuclear deterrent systems',
  ...
  image: book.imageUrl || '/book-covers/sonic-to-standoff.jpg',
  ...
  about: [
    ...
    'RAF Nuclear Force',
    'Nuclear Strategy Development'
  ],
  keywords: book.tags?.join(', ') || 'Nuclear Deterrent, Cold War, Strategic Forces',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://charlesmackaybooks.com/books/sonic-to-standoff'
  }
}

export default function SonicToStandoffPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <Image
                  src={book.imageUrl || '/book-covers/sonic-to-standoff.jpg'}
            ...
            <div>
              <div className="text-sm text-gray-300 mb-3 flex items-center gap-2">
                <span>Nuclear Strategy</span>
                <span>•</span>
                <span>Cold War Aviation</span>
                <span>•</span>
                <span>British Deterrent</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 text-center">
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <div className="text-lg font-semibold">9781838056794</div>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
