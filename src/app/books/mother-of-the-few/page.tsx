...
const book = books.find(b => b.id === 'mother-of-the-few')!
...
const jsonLd = {
  ...
  isbn: book.isbn,
  isbn10: '1838056777',
  isbn13: '9781838056777',
  numberOfPages: book.pageCount,
  datePublished: book.publicationYear?.toString() || '2022',
  author: {
    '@type': 'Person',
    name: 'Charles E. MacKay',
    description: 'Aviation historian specializing in aviation patronage and women in aviation history',
  ...
  image: book.imageUrl || '/book-covers/mother-of-the-few.jpg',
  genre: 'Aviation Biography',
  about: [
    'Lucy Lady Houston Biography',
    'Aviation Sponsorship History',
    'Women in Aviation',
    'Schneider Trophy',
    'Mount Everest Flight'
  ],
  keywords: book.tags?.join(', ') || 'Lady Houston, Aviation Patronage, Women Aviation',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://charlesmackaybooks.com/books/mother-of-the-few'
  }
}

export default function MotherOfTheFewPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <Image
                  src={book.imageUrl || '/book-covers/mother-of-the-few.jpg'}
            ...
            <div>
              <div className="text-sm text-blue-300 mb-3 flex items-center gap-2">
                ...
                <span>•</span>
                <span>Women in Aviation</span>
                <span>•</span>
                <span>Aviation Patronage</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 text-center">
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <div className="text-lg font-semibold">9781838056777</div>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
