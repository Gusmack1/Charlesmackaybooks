  ...
  return (
    <>
      <div style={{ background: 'var(--navy)', padding: '32px 24px', textAlign: 'center' }}>
        <h1 style={{ fontFamily: 'var(--font-serif)', color: 'white', fontSize: 28, marginBottom: 4 }}>All Books</h1>
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>20 titles covering Scottish &amp; military aviation history</p>
      </div>
