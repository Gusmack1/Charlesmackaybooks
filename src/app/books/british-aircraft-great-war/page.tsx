  ...
  const relatedBlogs = [
    {
      ...
      title: 'Expert Analysis: british aircraft great war rfc rnas',
      excerpt: 'Comprehensive historical analysis with expert commentary and rare archival material.',
      readingTime: 12
    },
    {
      id: 'sopwith-camel-wwi-fighter',
      title: 'Expert Analysis: sopwith camel wwi fighter',
      excerpt: 'Comprehensive historical analysis with expert commentary and rare archival material.',
      readingTime: 12
    },
    {
      id: 'bristol-fighter-f2b-brisfit',
      title: 'Expert Analysis: bristol fighter f2b brisfit',
      excerpt: 'Comprehensive historical analysis with expert commentary and rare archival material.',
      readingTime: 12
    }
  ];
