...
export default function BookPage() {
  const description = "Comprehensive study of British military aviation during World War I, covering RFC, RNAS aircraft development, combat operations, and technological innovations.";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-center items-center gap-4 text-sm">
            ...
            <div className="flex gap-3">
              <a 
                href={`https://facebook.com/sharer/sharer.php?u=https://charlesmackaybooks.com/books/british-aircraft-great-war`}
                target="_blank" 
              ...
              <a 
                href={`https://twitter.com/intent/tweet?url=https://charlesmackaybooks.com/books/british-aircraft-great-war&text=${bookData.title}`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
              ...
              <a 
                href={`https://linkedin.com/sharing/share-offsite/?url=https://charlesmackaybooks.com/books/british-aircraft-great-war`}
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:bg-blue-800 px-3 py-1 rounded transition-colors"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <Image
                  src={bookData.imageUrl || `/book-covers/british-aircraft-great-war.jpg`}
                  alt={bookData.title}
                  width={400}
                  height={600}
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-4 not-prose">
                <Link href="/blog/british-aircraft-great-war-rfc-rnas" className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200">
                  <h4 className="font-semibold text-blue-600">british aircraft great war rfc rnas</h4>
                  <p className="text-sm text-gray-600 mt-2">Read our detailed analysis...</p>
                </Link>
                <Link href="/blog/sopwith-camel-wwi-fighter" className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200">
                  <h4 className="font-semibold text-blue-600">sopwith camel wwi fighter</h4>
                  <p className="text-sm text-gray-600 mt-2">Read our detailed analysis...</p>
                </Link>
              </div>
            </div>
