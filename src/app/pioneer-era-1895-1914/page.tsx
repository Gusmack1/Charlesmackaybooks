...
export default function PioneerEraPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="#featured-books"
                className="bg-linear-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
      ...
      <section id="featured-books" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center">
            <Link
              href="/books"
              className="bg-linear-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
            >
      ...
      {/* Next Era Section */}
      <section className="py-20 bg-linear-to-r from-amber-600 to-red-600 text-white">
