...
export const metadata: Metadata = {
  ...
  description: 'Learn about Charles E. MacKay, renowned aviation historian and author specializing in Scottish aviation heritage, WWI & WWII aircraft, and military aviation history.',
  keywords: ['Charles MacKay biography', 'aviation historian', 'Scottish aviation author', 'WWI aviation expert', 'military aviation historian'],
  openGraph: {
    title: 'About Charles E. MacKay - Aviation Historian & Author',
    description: 'Learn about Charles E. MacKay, renowned aviation historian and author specializing in Scottish aviation heritage, WWI & WWII aircraft, and military aviation history.',
    type: 'website',
