...
export const books: Book[] = [
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'This was the Enemy The Luftwaffe 1945 ISBN 9781838056780 (Newly Published - 8 May 2025). This is the first volume in the series of 288 Pages which is profusely illustrated with many and unknown and rare photographs. A limited run. A5 Paperback highly detailed, 180 pages profusely illustrated with nearly 300 pictures many of them rarely published.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'Flying for Kaiser Wilhelm 1914-1918: ACES, AEROPLANES & DEFEAT. Starts at 1919, includes co-operation with the Soviet Union at Lipetsk, designed to circumvent the Versailles Treaty restrictions. It looks at the controversy of Guernica and the return of the Legion to Germany in 1939 under von Richthofen. Companion to Soaring With Wings-Percy Pilcher Wants To Fly.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'Dieter Dengler, Skyraider 04 Down, the Man the Ship the Plane NEW. This was the Enemy the Luftwaffe 1945 ISBN 9781838056780 times of the American Hero - Dieter Dengler. Included is the history of the American Hero - Dieter Dengler. This is the first volume in the series of 288 Pages which is profusely illustrated with many and unknown and rare photographs.',
