...
Armament shows the work of Rheinmetall Borsig and Mauser with the company histories to 1945. Includes automatic weapons and converted artillery pieces for aircraft use by Mauser and Rheinmetall Borsig. All classes of bombs are illustrated with technical drawings. The appendix closes with the Blohm unt Voss asymmetrical aircraft.
288 pages A5, over 300 pictures, 58000 words Accurate Bibliography  ISBN:9781838056797`,
...
·        Investigates aero – engine development by the Ministry of Munitions at Arrol Johnston and Siddeley Deasy. Covers the aero- engine programmes with statistics, never before published.

·        An in – depth history of H.M.S. Argus from 1918 to her scrapping in 1946 including Chanak, Shanghai and Operations Torch and Harpoon. Covering the first aircraft carrier landings by Bell-Davis from RAF Turnhouse and ends with the last flight of a Swordfish in September 1944.There are details of her after action damage in Operation Torch
...
"... a splendid account." recent buyer
 ...
 Brand new - Unread - Just off the Press Beardmore Aviation at excellent value.`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `A detailed description of the history of Aviation on Clydeside from 1785 to 1919.
...
`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Clydeside Aviation Volume Two Between the Wars ISBN: 9780957344372. Condition is New. Dispatched with Royal Mail 2nd Class Large Letter.
...
"Amazing depth of research. Fascinating. Must get vol.1." February buyer.`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `GERMAN AIRCRAFT IN THE GREAT WAR 1914 -1918 ISBN: 9781838056742 A5 256 pages + 200 images.
...
Additional material will be found in Volume 2 "Flying for Kaiser Wilhelm 1914-1918" which is also available from this website.
"....Great book." - recent purchase (March)

Any Questions promptly answered-thanks for looking`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `British Aircraft of the Great War, FIGHTERS BOMBERS ETC ISBN: 9781838056704. Condition is New. Dispatched with Royal Mail 2nd Class Large Letter.
...
"A1 Product + Prompt Delivery - HIGHLY RECOMMENDED" March 2021 buyer

"Great deal pleased with the book well packed fast postage as described and a 
bonus of some black and white cards of WW 1 aircraft, thank you very much 👍🏼👍🏼" May 2025 purchase


This book has best offer option.
`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Brand new with no scuffs or markings. The history of the helicopter from earliest times to 1960 includes Cierva, Focke Achgellis, Sikorsky, Weir etc. Researched from company records and contemporary publications.
...
The Germans are not neglected with a full chapter on Focke Achgellis, Dobblehoff, Liore et Olivier etc. Hanna Reitsch and her test flights on the FA-61 are included. Wartime German Helicopter production is included and its influence on American and British helicopter development. 
...
Introduces the finances of Power Jets and intelligence intrigue at Power Jets and Weir/Cierva. A further insight into helicopters and H. Morris & Co., Ltd (Morris Furniture Glasgow) can be found in our related titles.
...
BEFORE making a best offer could you please contact me first because there is a lot of confusion with the terms. Its best to clear it up first before going forward with a best offer, many thanks for looking and your patience`,
...
Winkle Brown flew off the carrier vessel, HMS Argus, a training post he disliked.

Into its tenth print due to popular demand, price held, highly sought after. Post Free

ISBN 9780957344365

"Amazing pilot, all those 'planes, amazing" - buyer

"Very good communication, exactly as described, extremely well packaged and protected." - recent buyer

"Alan's book captures the essence of him well."

"Loved the book" recent comment.

"VERY QUICK DELIVERY, REALLY GOOD BOOK AND GREAT PRICE" recent buyer.

"Excellent overview of the world's greatest pilot." April 2023 purchase
...
ISBN 9780957344365`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Sabres from the North: Mutual aid during the Cold War NEWLY Published.
...
POST FREE ROYAL MAIL
 ...
 "A very interesting book." - recent buyer
...
`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `This was the Enemy
...
Highly recommended for the enthusiast and general reader alike. (Use offers)`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Flying for Kaiser Wilhelm 1914-1918.
...
"..Great Book" Recent purchase`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `A new biography of Percy S. Pilcher and his four years of experimental flying.
...
`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Mother of the Few, The Aviation Interests of Lucy Lady Houston ISBN:9781838056711. Condition is "New". Dispatched with Royal Mail 2nd Class.
...
Part two explores the Schneider Trophy with new information on Brinton and the fates of the aircrew and their seaplanes. It shows the development of the "R" engine in relation to Stainforth the air race and how it was developed from the Rolls-Royce Buzzard and evolved into the Rolls-Royce Merlin. The fuels were a winner with the engine and they too are described.
...
"The book arrived in tack and quickly. The item was carefully packed and as described.
It was good value and an interesting read" recent purchase`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `102 Pages A5, describing the life and times of the American Hero - Dieter Dengler. Included is the history of the USS Ranger and her deployments off Vietnam. Dieter Dengler flew the Douglas Skyraider and the aircraft history is included with Royal Navy service and service in Sweden.
His was the first escape from Laos in 1966. His captivity was horrendous.
...
"Top seller. Fast shipping. Nice item. Perfect!" Recent sale`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `A rare insight into the British Furniture industry in peace and war.
...
Morris also produced aircraft wood and the wings and tail for the group built Armstrong Whitworth Albemarle bomber/transport. Nearly a million Lee – Enfield rifles were produced in conjunction with Singers and Albion Motors. They also produced a wooden engine for Frank Whittler's Power Jets.
...
• The Cloud Table, designed by Neil B. Morris, created a sensation due to its distinctive shape and size in the post-war era.
...
A fuller investigation of Morris and the development of the British helicopter covers the Bristol Sycamore, Sikorsky Hoverfly, the Cierva types and such types as the German Focke - Achgelis, Doblehoff helicopters and Hanna Reitsch.
...
This is not a compilation of internet articles or a print on demand book. Shavings for Breakfast has been originally researched and printed in the United Kingdom and comes highly recommended for the student and general reader alike.`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `1945 Statements on the Atomic Bomb Churchill ALSOS German Bomb, Oppenheimer MAUD
...
These are the source documents for all atomic bomb publications and were part of "Sonic to Standoff" which is also available from this website
...
Purchased July 2025`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Not a download or print on demand publication.
...
Due to the popularity of Recollections of a Tour Made in Scotland its now in its seventh printing. A highly recommended paperback that can fit in the pocket or case while travelling round the Scottish Borders and West of Scotland.`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `Adolf Rohrbach and Rohrbach Metall-Flugzeugbau GmbH.
ISBN:9781838056728

Adolf Rohrbach's Metal Aeroplanes – An Aircraft Pioneer And His Designs
...
"Great service, a nice cheap and cheerful book, well worth the value." buyer, July 2021  `,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: `The story of an extraordinary project making Britain a superpower.
...
The source documents are available from this website.
...
export const books: Book[] = sourceBooks;
