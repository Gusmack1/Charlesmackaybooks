...
288 pages A5, over 300 pictures, 58000 words Bibliography`,
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'GERMAN AIRCRAFT IN THE GREAT WAR 1914 -1918 ISBN: 9781838056742 A5 256 pages + 200 images. A comprehensive and original look at the German Air Force and German Naval Air Arm in the First World War 1914-1918. For the first time in print a complete breakdown of the organisation and the German system of supply. Commences with early German aviation to the opening of Johannisthal airfield in 1909 and the growth of Anthony Fokker and his aircraft. For the first time a complete and accurate account of the formation of German aviation and German military aviation which is based on Allied intelligence and newly translated archive documents. The industry reports are based on the inspections of the League of Nations Inter-Allied Control Commissions on aviation 1919 - 1926. There is special mention of the Fokker D.VII and its fate. Included lists of German aerodromes and the organisation of the German Naval Air Arm in November 1918 (Orders of Battle). For the first time there is a complete description of the German Naval Air Arm the Marine-Fliegerabteilung in the First World War with orders of battle, including Armistice Day 1918 and the air arm\'s dominance over the English Channel with the Flanders Flight gaining air superiority. (Included are the giant Riesenflugzeuge aeroplanes and their raids on London.) The aces are not forgotten with an accurate account of the loss of Manfred von Richthofen with his autopsy report, proving Brown did not shoot him down. The other aces Oswald Boelcke and Max Immelmann are described with new information. Also included is Fraulein Mellie Beese, the first German woman pilot who set up a training school at Johannisthal Berlin. There are descriptions of the German aircraft industry, spares supply and the aftermath of the Armistice including the Amerika Programme and the Hindenburg plan. Includes all the aviation firms and their designations. There are orders of battle of the German squadron in the field on the Western Front and the deployment of the German bomber force the Giants - the Riesenflugzeuge. Including Linke Hofmann, Staaken, D.F.W. Zeppelin giant bombers. There is emphasis on the training squadrons and depots. There is fresh information on the all-metal Zeppelin Staaken based on the League of Nations inspection reports of the Inter-Allied Control Commissions: the inspectors found a second Staaken air liner in production. This too is supported with fresh drawings and pictures. There is a comprehensive appendix. 256 pages over 200 original black and white pictures and drawings. Additional material will be found in Volume 2 "Flying for Kaiser Wilhelm 1914-1918" which can only be found on EBay.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'Brand new with no scuffs or markings. The history of the helicopter from earliest times to 1960 includes Cierva, Focke Achgellis, Sikorsky, Weir etc. Researched from company records and contemporary publications. The Sycamore Seeds has 219 Pages, A5 - profusely illustrated with over 300 rare pictures and one colour. There are unique drawings and illustrations published for the first time. Covers the history of the Denny Mumford helicopters up to 1914. The history of the Autogiro is covered and the role of Juan de la Cierva to his death in an air crash. It investigates the role of G & J Weir and the first British helicopters including the Weir W5 and W6. Takes the history past WW2 to the Cierva W9 and the giant Air Horse. The evolution of the tailless rotor on the Cierva W.9 is accurately explained based on company records of Weir, Cierva and Morris, as is the Weir Company\'s invention of the Fenestron tail fan. The Air Horse, designed by Shapiro, has its history detailed to its eventual crash and demise, taking the lives of Alan Marsh and Jeep Cable. The Germans are not neglected with a full chapter on Focke Achgellis, Dobblehoff, Liore et Olivier etc. Hanna Reitsch and her test flights on the FW61 are included. Wartime German Helicopter production is included and its influence on American and British helicopter development. The flight of Cierva and Reggie Brie from Italien cruisers is highly detailed. Covers the history of the Cierva C30 in Royal Air Force service including the radar calibration flights and the 1943 dogfight of Norman Hill in his Rota I. (This is the first published description in any book). He had been intercepted over Hawkinge by two FW190s and by various manoeuvres survived to tell the tale. Includes the evolution of the Flying Jeep and the single pilot Rotachute with the Bristol Sycamore. Also included the American development of the Sikorsky Hoverfly. Morris furniture manufactured the blades for the Jeep, the Rotachute, Bristol Sycamore and wooden blades for the Sikorsky Hoverfly. The setting up of the Joint Helicopter School at Floyd Bennett Field is included as are the anti - submarine test flights on the MV Daghestan. This includes the development of the Sikorsky Hoverfly at sea and its use in the UK by the Royal Air Force and Royal Navy. The Hoverfly unit was a combined Royal Navy/ United States Coast Guard unit at Brooklyn airfield. Project Ivory Soap is detailed and the use of the Hoverfly off supply ships. Development of the Bristol Sycamore up to the Bristol 192. Introduces the finances of Power Jets and intelligence intrigue at Power Jets and Weir/Cierva. The description of the Cierva Air Horse is from those who were there. Gives an explanation of helicopter patents and aeronautical research reports from NACA and the RAE. This is an insight how Focke patents were infringed. There is a comprehensive Bibliography and appendix with a biography of Jeep Cable and the rotor craft he flew etc. This is not a compendium of Wikipedia articles, this is an original work and is not an on-demand print or a compilation of search answers from web sites.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'Flying for Kaiser Wilhelm 1914-1918. Clean and unmarked straight off the press published 12 July 2023, Volume Two of German Aircraft in the Great War. Not a compilation of internet articles but newly researched using original documents from the period. Probably for the first time a complete list of aeroplanes transferred to the Americans at the Armistice. In August 1914 there were 12 German aircraft companies manufacturing aeroplanes. By 1918 there were 33 aircraft manufacturers and the companies employed 60000 workers. At the time of the Armistice the German aircraft industry had manufactured in total between 48000 and 49000 aeroplanes. As part of an expansion programme the army depended heavily on captive balloons for aerial observation. In 1916 the German air service was reorganized by Ernst von Hoeppner. At that time he introduced fighter wings to counteract the Entente aerial forces giving rise to the "Ace." Using captured documents, newly translated, Flying for Kaiser Wilhelm, describes the wartime situation and the sudden fall of Germany on the Western Front. With the collapse in November 1918, Germany lost the war, her Emperor and Crown Prince and endured a draconian Armistice. Contents: 1. Biographies and illustrations of Pour le Merite (Blue Max) pilots, includes Udet and Goring. 2. Armament - Spandau and Parabellum. German aerial bombs with diagrams. 3. Training methods for observers, mechanics and pilots. Lists training air bases, aircraft companies, spares production and military flying schools. 4. Biographies of Kaiser Wilhelm II and the Crown Prince. 5. Describes the collapse of Germany on the Western Front and the draconian Versailles Treaty with an accurate account of the events on the railway carriage at the Forest of Compiègne and Marshall Foch 11 November 1918. Lists all aircraft handed over to the Allies and the Americans at Coblenz including the Fokker D.VII and the Roland D.VI. Serials are given for all aircraft as well as illustrated with rare photographs of the aircraft in storage. 6. German observation balloons are included together with training methods and deployment in the German observation service. 7. German captured aircraft exhibition in London November 1918 described by C.G. Grey editor of Aeroplane. 8. The evolution of the machine gun interrupter gear and the influence of Roland Garros. Lays aside the myth of Anthony Fokker inventing the interrupter apparatus. 9. A description of Lieutnant Richter and the loss of the spherical balloon, "Luna" in 1910 in the Baltic. A limited run. A5 Paperback highly detailed, 180 pages profusely illustrated with nearly 300 pictures many of them rarely published.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: '102 Pages A5, describing the life and times of the American Hero - Dieter Dengler. Included is the history of the USS Ranger and her deployments off Vietnam. Dieter Dengler flew the Douglas Skyraider and the aircraft history is included with Royal Navy service and service in Sweden. His was the first escape from Laos in 1966. Gives details of Denglers\'s early life in Germany, his moving to the United States, his education (He lived in a van) and his induction into the United States Navy.There is a thrilling account of his capture, imprisoment and escape based on CIA reports.The appendix includes Media and the Scottish Aviation Skyraider for Sweden. He flew off the USS Ranger, CV-61, on his final flight. His squadron was Attack Squadron VA-145. In his last operational sortie he flew the Douglas A-1 Skyraider. Companion to Soaring With Wings-Percy Pilcher Wants To Fly.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'The original story of the Atomic bomb, its invention and deployment. The chronicle of its manufacture, its use against Japan and how it was installed in the Boeing B-29 Superfortress in "Silverplate." These are the first published statements by the United Kingdom, Canada and the United States in August 1945. "The British deserve much of the credit for the Atomic Bomb—their research was way ahead of ours when the project was turned over to the United States to develop because our laboratories and manufacturing facilities were out of range of bombing and it was the Prime Minister who sold the idea of pushing the project to both the British and United States Governments." W. Averell Harriman, United States Ambassador to the Soviet Union, 7th August 1945. 1945 Statements on the Atomic Bomb includes all aspects of the ALSOS Mission, Canada, United States and the German Atomic Bomb. ISBN: 9780957344396. Condition New. 192 Pages, A5 - 66 black and white pictures with three drawings including a 3 view drawing of a B-29. The cover shows the cockpit view from a B-29 based at Tinian in 1945. Dispatched with Royal Mail 2nd Class. These are newly restored statements from lost documents published by the Allies in August 1945 on the development and deployment of the Atomic Bomb. The book includes statements on ALSOS, M.A.U.D., Quebec Agreement, Chickenpox, Silverplate etc. The book explains what Silverplate, Chickenpox etc. in terms of atomic weapons deployment. The restored documents are:- 1. Statements relating to the Atomic Bomb - Winston Churchill 1945. This described the formation of "Tube Alloys" and its integration with the American Manhattan District/Project. 2. Report on the use of Uranium for a Bomb (M.A.U.D. Committee/M.A.U.D. Report) with drawings. 3. Quebec Agreement between the United Kingdom and the United States of America.(Still in force today.) 4. Statement by C.D. Howe, Canadian Minister. 5. Statement by the Office of the Minister of Reconstruction Ottawa, Canada.(Lists all the Allied atomic scientists). 6. Harry S. Truman - Statement by the President of the United States. 7. Statement on the Bombing of Japan by Henry Stimson. 8. Silverplate - the development of the Atom bomb carrying B-29 Superfortress, their fate and deployment. The word Silverplate refers to the modifications of the Superfortress to carry the atomic bomb. 9. ALSOS Mission - the inspection of the Nazi Germany capability to produce atomic weapons and the mythological work of Heisenberg and Nazi ideology. Includes drawings of the proposed German Atomic Bomb. 10. Peppermint - the preparation of the Allies for the deployment by the Nazis of nuclear products for the invasion of Europe. 11. Chickenpox - the American preparations for the deployment of atomic bombs in aircraft post - war. 12. Statement by J.R. Oppenheimer - on the deployment of British Scientists on the Manhattan Project. There are fresh details of British scientists working on the Atomic Bomb project at Los Alamos by Oppenheimer including Groves and Chadwick. The Alsos chapter includes details of Joliet Currie, Heisenberg and the German scientists which are rarely published. The official conclusion of this chapter is that the Nazis could never have produced an Atomic Bomb and prepares the reader for the post-war propaganda that the German scientists tried to delay the Bomb\'s production or that one was in preparation for use. From these statements it can be deduced that the first uranium bomb, dropped in August 1945 was based on the British M.A.U.D. technology. The Statements are from Harry Truman, United States, Winston S. Churchill (for the first time published in its entirety since 1945 "Statements Relating to the Atomic Bomb"), United Kingdom and C.D. Howe for Canada. There are scientist lists and details of Fat Man and Little Boy Atomic Bombs. These documents are of great historical value since neither nation repeated their publication on the birth of the bomb. These are the source documents for all atomic bomb publications and were part of "Sonic to Standoff" which can be found in EBay.co.uk. 1945 Statements on the Atomic Bomb presents all the Allied documents co-ordinated in one volume and is highly recommended.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'The story of an extraordinary project making Britain a superpower. Chronicling part of the development of the British Nuclear Defence Programme, Sonic to Standoff traces the evolution of the British Blue Steel standoff nuclear bomb. Included are the test phases in Australia and the work of Lord Penney. It covers the work of Tube Alloys and brings to light more information on the special relationship between the United Kingdom and the United States. Shows how the system was based on German technology, commences with the giant Paris Gun and then starts from Germany in 1919 with gliding and the German flying school in Russia, the inventors Lippisch, von Braun and Dornberger and the HWK rocket, the Me163 and its rocket motor in the Vickers Trans-Sonic missile of 1947. Introduces the Royal Air Force and the Victor, Vulcan, Valiant, Sperrin, Canberra and Washington bombers and the Silverplate B-29. The book gives details of the development of British free-fall nuclear devices (WE177), Blue Steel, Polaris and Thor - not found in recent publications. There are two tables of organisation describing the Order of Battle of the Royal Air Force in 1970 at the height of the Cold War. The book ends on the banks of the River Clyde at Faslane, Scotland. A new insight into the Royal Air Force in the Cold War. Describes the evolution of the British Nuclear Deterrent in original research. Has the evolution of the German rocket includes the Walther rocket in the ME163 and German missile development. The details were incorporated into the British nuclear standoff bomb. Commencing at Versailles 1919, then the Germans in Russia at the Lipetsk flying school and at Fili aircraft assembly plant, with Hugo Junkers and Ernst Heinkel. There is clear explanation of German rocket development with details of Enzian and Schmetterling at Rechlin and Peenemunde. All the inventors are mentioned including the Nazi, von Braun and Willy Ley. Explains the importance of Hitler\'s visit to Rechlin with Goering. Included are charts of German and Russian developments never before published. There is the RAE use of the Mosquito to drop the first test missiles. Investigates all the UK early missile testing with the Miles M52 and the Power Jets W2/700 at Aberporth and Woomera. There is also description of the M52 designed with the V1 rocket engine and the Gillette Falcon. The M.52 design was seen by the americans and influenced the Bell X1. The V Bombers, Victor Vulcan and Valiant described. Included are details of the Atom bomb Lancaster. The importance of the Canberra and the atomic bomb development explained and not neglected. Brings in the Washington B1 and the Short Sperrin. Never before published photographs of the British Superfortress on Blue Jay and Red Dean and WE177 trials. Has a listing of all Silverplate/Chickenpox B-29s and the American use of the Maud Report. British Nuclear testing and the work of William George Penney in Operation Hurricane and the British Hydrogen bomb are included. Brings in the Quebec Agreement and the acquisition of Skybolt with Hound Dog and Rascal on the B-52. Rascal is covered in some detail. Describes the "Special Relationship," between the United Kingdom and the USA. Follows the development of the HWK rocket motor and its use in British airframes culminating in Blue Steel. Profusely illustrated with pictures never before published. The source documents can be found here:- https://www.ebay.co.uk/itm/323746748368?ssPageName=STRK:MESELX:IT&_trksid=p3984.m1555.l2649.',
