...
export const books: Book[] = [
  {
    ...
    condition: 'New',
    inStock: true,
    description: 'How Scotland’s great engineering house went airborne. Using original company archives and Admiralty papers, this history follows Beardmore from Sopwith shipboard fighters and Handley Page bombers to HMS Argus, the first true flat‑deck carrier. It documents the W.B. aircraft family, the Inflexible, and the Typhoon/Cyclone/Tornado engines for the R101 era, with production totals, contracts and rare factory photography.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'Percy Pilcher—Scotland’s Icarus. This biography, based on family papers, university records and contemporary journalism, follows his advanced hang‑gliders of the 1890s, Glasgow lectures, meetings with Lilienthal and influence on the Wrights, and recounts the fatal Cardross demonstration, with restored images and site maps of Auchensail and Cardross.',
...

  {
    ...
    condition: 'New',
    inStock: true,
    description: 'From V‑bombers to Trident, a declassified history of Britain’s nuclear deterrent. Covers the V‑Force, Blue Steel standoff weapon, Polaris submarines and the modern Trident posture, with aircraft, missiles, bases and doctrine explained in plain language and grounded in primary documentation.',
